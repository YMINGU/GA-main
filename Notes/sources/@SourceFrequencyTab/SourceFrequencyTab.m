classdef SourceFrequencyTab < handle
...
%     offset;         not sure how to relate with wavelength/frequency
  ...
  methods
    function obj = SourceFrequencyTab()
      if nargin == 0
        obj.WavelengthCoordinates = FrequencyTabCoordinates();
        obj.FrequencyCoordinates = FrequencyTabCoordinates();
        %obj.SourceType = 'broadband source';co
      end
    end
