...
function runFDTD(effectiveThickness, t, a1, rTop1, rBot1)
P = a1;
L = t;
...
SimulationModel = Model(NCTop.create_withEquivalentThickness(effectiveThickness, t, a1, rTop1, rBot1), PlaneSource, FrequencyDomainFieldPower, FrequencyDomainFieldPower, FDTD);
...
geo.XMax = ReSpan/2;
geo.YSpan = ReSpan;
geo.Z = L/2 + filmCone.ConeZSpan + geo.OffSet;
...
geo.YSpan = P;
geo.ZMin = -L/2;
geo.ZMax = L/2 + filmCone.ConeZSpan + geo.OffSet;
