classdef FrequencyDomainFieldPowerGeneralTab < handle & matlab.System
  ...
  methods
    function obj = FrequencyDomainFieldPowerGeneralTab(varargin)
      if nargin == 0
        % Default values
