classdef MonitorGeometryTab < handle & matlab.System
 
  properties
    MonitorType;  % 1.Point, 2.Linear X, 3.Lineary Y,  % 4.Linear Z, 5.2D X-normal, 6.2D Y-nomral, % 7.2D Z-normal, 8.3D
    DownSampleX;
    DownSampleY;
    DownSampleZ;
    OffSet;
  ...
  methods   
    function obj = MonitorGeometryTab(varargin)
      if nargin == 0
